...
Therefore, it is system-agnostic; the data need only be put into a very simple structure (time against oxygen in any units) for a full analysis to be conducted. 
