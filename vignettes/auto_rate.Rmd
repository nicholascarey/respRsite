...
Generally, `auto_rate` identifies multiple linear regions and ranks them, and by default the highest ranked one is returned. 
However, as a fully automated, unsupervised method of identifying linear data it is fallible, and the results should always be inspected and explored. 
